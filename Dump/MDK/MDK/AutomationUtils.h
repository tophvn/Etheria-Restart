...
public:
	...
	// void TakeGameplayAutomationScreenshot(FString ScreenshotName, float MaxGlobalError, float MaxLocalError, FString MapNameOverride); // [0x1286220] Final|Native|Static|Public|BlueprintCallable 
};
