...
public:
	...
	CMember(TEnumAsByte<EPhysicsType>)                 PhysicsType                                                 OFFSET(get<T>, {0x30, 1, 0, 0})
	CMember(TEnumAsByte<ECollisionTraceFlag>)          CollisionTraceFlag                                          OFFSET(get<T>, {0x31, 1, 0, 0})
	CMember(TEnumAsByte<EBodyCollisionResponse>)       CollisionReponse                                            OFFSET(get<T>, {0x32, 1, 0, 0})
};
...
public:
	...
	DMember(bool)                                      bEnableShapeSharing                                         OFFSET(get<bool>, {0x50, 1, 0, 0})
	DMember(bool)                                      bEnablePCM                                                  OFFSET(get<bool>, {0x51, 1, 0, 0})
	DMember(bool)                                      bEnableStabilization                                        OFFSET(get<bool>, {0x52, 1, 0, 0})
	DMember(bool)                                      bWarnMissingLocks                                           OFFSET(get<bool>, {0x53, 1, 0, 0})
	DMember(bool)                                      bEnable2DPhysics                                            OFFSET(get<bool>, {0x54, 1, 0, 0})
	DMember(bool)                                      bDefaultHasComplexCollision                                 OFFSET(get<bool>, {0x55, 1, 0, 0})
	DMember(float)                                     BounceThresholdVelocity                                     OFFSET(get<float>, {0x58, 4, 0, 0})
	CMember(TEnumAsByte<EFrictionCombineMode>)         FrictionCombineMode                                         OFFSET(get<T>, {0x5C, 1, 0, 0})
	CMember(TEnumAsByte<EFrictionCombineMode>)         RestitutionCombineMode                                      OFFSET(get<T>, {0x5D, 1, 0, 0})
	DMember(float)                                     MaxAngularVelocity                                          OFFSET(get<float>, {0x60, 4, 0, 0})
	DMember(float)                                     MaxDepenetrationVelocity                                    OFFSET(get<float>, {0x64, 4, 0, 0})
	DMember(float)                                     ContactOffsetMultiplier                                     OFFSET(get<float>, {0x68, 4, 0, 0})
	DMember(float)                                     MinContactOffset                                            OFFSET(get<float>, {0x6C, 4, 0, 0})
	DMember(float)                                     MaxContactOffset                                            OFFSET(get<float>, {0x70, 4, 0, 0})
	DMember(bool)                                      bSimulateSkeletalMeshOnDedicatedServer                      OFFSET(get<bool>, {0x74, 1, 0, 0})
	CMember(TEnumAsByte<ECollisionTraceFlag>)          DefaultShapeComplexity                                      OFFSET(get<T>, {0x75, 1, 0, 0})
	SMember(FChaosSolverConfiguration)                 SolverOptions                                               OFFSET(getStruct<T>, {0x78, 104, 0, 0})
};
